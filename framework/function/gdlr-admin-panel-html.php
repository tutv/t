	...
	class gdlr_admin_option_html {
		...
		function generate_admin_option( $settings = array() ) {
			if ( $settings['type'] == 'row' ) {
				echo '<div class="gdlr-option-row ' . ( empty( $settings['class'] ) ? '' : $settings['class'] ) . '">';
			...
			switch ( $settings['type'] ) {
				case 'text':
					$this->print_text_input( $settings );
					break;
				case 'textarea':
					$this->print_textarea( $settings );
					break;
				case 'combobox':
					$this->print_combobox( $settings );
					break;
				case 'font-combobox':
					$this->print_font_combobox( $settings );
					break;
				case 'multi-combobox':
					$this->print_multi_combobox( $settings );
					break;
				case 'checkbox':
					$this->print_checkbox( $settings );
					break;
				case 'radioimage':
					$this->print_radio_image( $settings );
					break;
				case 'colorpicker':
					$this->print_color_picker( $settings );
					break;
				case 'skin-settings':
					$this->print_skin_settings( $settings );
					break;
				case 'sliderbar':
					$this->print_slider_bar( $settings );
					break;
				case 'slider':
					$this->print_slider( $settings );
					break;
				case 'upload':
					$this->print_upload_box( $settings );
					break;
				case 'uploadfont':
					$this->print_upload_font( $settings );
					break;
				case 'custom':
					$this->print_custom_option( $settings );
					break;
				case 'date-picker':
					$this->print_date_picker( $settings );
					break;

				case 'description':
					echo '<div class="gdlr-option-description">' . $settings['description'] . '</div>';
					break;
				case 'fas':
					$this->print_fas_option( $settings );
					break;
				case 'ssp':
					$this->print_ssp_option( $settings );
					break;
			}
