...
if ( !function_exists( 'gdlr_hotel_include_script' ) ) {
	function gdlr_hotel_include_script() {
		...
		wp_enqueue_script( 'datetimepicker-full', plugins_url( 'datetimepicker.full.js', __FILE__ ), array(), '1.0.0', true );
		wp_enqueue_script( 'datetimepicker-min', plugins_url( 'datetimepicker.min.js', __FILE__ ), array(), '1.0.0', true );
		wp_enqueue_script( 'booking-tennis-court', plugins_url( 'booking-tennis-court.js', __FILE__ ), array(), '1.0.0', true );
